...
INFO = [
    ...
    ("Edu",      "B.S. CS  ·  Class of 2028 & B.S. P  ·  Class of 2023, UTRGV", "val"),
    ("Focus",    "Robotics ✭ AI ✭ full-stack software dev", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "Python · C++ · JavaScript · SQL · HTML", "val"),
    ...
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "cloudia-cassandra.github.io", "accent"),
    ("In",       "linkedin.com/in/claudia-cassandra", "accent"),
