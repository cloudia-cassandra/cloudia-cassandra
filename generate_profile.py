...
INFO = [
    ...
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Prog Langs",     "Python · C++ · JavaScript · SQL · HTML", "val"),
    ("Backend",  "Java · Node.js", "val"),
    ("AI",       "LLMs", "val"),
    ("Infra",    "AWS Bedrock · Kubernetes", "val"),
    ("Data",     "PostgreSQL", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("DRSAP",     "Autonomous volume measurement drone", "warn"),
    # ("",         "impact: ##  ->  < ##", "muted"),
    ("Orchestra", "Multi-agent system + tools + memory + HITL", "warn"),
    ("Laurel", "Multi-agent system + HITL scholarship matching", "warn"),
    ("",         "for non-traditional students", "warn"),
    # ("MediGuide", "ML health assistant · Springer LNNS (Scopus)", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    # ("Award",    "Runner-Up · INSPIRON 4.0 National Hackathon", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Langs",     "Español · English · Português · Français", "val"),
    ("Website",      "cloudia-cassandra.github.io", "accent"),
    ("LinkedIn",       "linkedin.com/in/claudia-cassandra", "accent"),
    # ("Mail",     "myemail@gmail.com", "accent"),
]

THEMES = {
    "dark": {
        "bg": "#0d1117", "panel": "#161b22", "border": "#30363d",
        "text": "#c9d1d9", "muted": "#8b949e", "key": "#ec4899",
        "accent": "#f3bfd6", "warn": "#fbcfe8", "art": "#f0a8d8",
        "prompt": "#ec4899", "dot1": "#ff5f56", "dot2": "#ffbd2e", "dot3": "#27c93f",
    },
    "light": {
        "bg": "#ffffff", "panel": "#f6f8fa", "border": "#d0d7de",
        "text": "#1f2328", "muted": "#59636e", "key": "#be185d",
        "accent": "#f3bfd6", "warn": "#ec4899", "art": "#d946a6",
        "prompt": "#be185d", "dot1": "#ff5f56", "dot2": "#ffbd2e", "dot3": "#27c93f",
    },
}
...
# RENDER
# ----------------------------------------------------------------------------
def render(theme_name, colors, stats, ct_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to opportunities to grow as an engineer</tspan>'
        f'<tspan class="cur" dx="8">█</tspan></text>'
    )
    parts.append(
        f'<text x="{W-34}" y="{fy}" class="mut" text-anchor="end">'
        f'last updated {ct_now}</text>'
    )
    parts.append("</svg>")
    return "\n".join(parts)
...
def main():
    ...
    stamp = ct.strftime("%d %b %Y, %H:%M CT")
